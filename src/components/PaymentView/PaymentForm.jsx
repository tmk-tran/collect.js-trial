...
function PaymentForm() {
  ...
  useEffect(() => {
    ...
    const loadScript = () => {
      ...
      script.src = "https://secure.bngpaymentgateway.com/token/Collect.js";
      script.async = true;
      script.setAttribute(
        "data-tokenization-key",
        // "7TzE7p-Xp22Ey-9Rb83Y-R4WS3z"
        "s6DA8E-7C9yB5-g9PPV4-5Q39p2"
      );
  ...
  return (
    <form style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{ marginTop: "50px" }}>
        <Button disabled={activeStep === 0} onClick={handleBack} sx={{ color: "ghostwhite" }}>
          Back
        </Button>
        <Button
          variant="contained"
